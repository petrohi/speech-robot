...
proc write_mig_file_speech_robot_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>speech_robot_mig_7series_0_1</ModuleName>}
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins acquisition/aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins exp/axi_resetn] [get_bd_pins motor_dir_gpio_0/s_axi_aresetn] [get_bd_pins motor_en_timer_0/s_axi_aresetn] [get_bd_pins motor_en_timer_1/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins stft/axi_resetn] [get_bd_pins tcu/axi_resetn]
