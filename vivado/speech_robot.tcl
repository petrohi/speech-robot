...
################################################################
# This is a generated script based on design: speech_robot
#
...
# source speech_robot_script.tcl
...
proc write_mig_file_speech_robot_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>speech_robot_mig_7series_0_0</ModuleName>}
...
proc create_hier_cell_tcu { parentCell nameHier } {
  ...
  # Create instance: top_speech_robot_0, and set properties
  set block_name top_speech_robot
  set block_cell_name top_speech_robot_0
  if { [catch {set top_speech_robot_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $top_speech_robot_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins top_speech_robot_0/instruction]
  ...
  connect_bd_intf_net -intf_net top_speech_robot_0_m_axi_dram0 [get_bd_intf_pins m_axi_dram0] [get_bd_intf_pins top_speech_robot_0/m_axi_dram0]
  connect_bd_intf_net -intf_net top_speech_robot_0_m_axi_dram1 [get_bd_intf_pins m_axi_dram1] [get_bd_intf_pins top_speech_robot_0/m_axi_dram1]

  # Create port connections
  connect_bd_net -net microblaze_0_Clk [get_bd_pins s_axi_lite_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins top_speech_robot_0/clock]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_resetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins top_speech_robot_0/reset]
...
# Hierarchical cell: exp
proc create_hier_cell_exp { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_exp() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: exp_0, and set properties
  set exp_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:floating_point:7.1 exp_0 ]
  set_property -dict [ list \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins to_float_0/S_AXIS_A]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S2 [get_bd_intf_pins M_AXI_MM2S] [get_bd_intf_pins axi_dma_0/M_AXI_MM2S]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM2 [get_bd_intf_pins M_AXI_S2MM] [get_bd_intf_pins axi_dma_0/M_AXI_S2MM]
  connect_bd_intf_net -intf_net floating_point_0_M_AXIS_RESULT [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins exp_0/M_AXIS_RESULT]
  connect_bd_intf_net -intf_net smartconnect_0_M10_AXI [get_bd_intf_pins S_AXI_LITE] [get_bd_intf_pins axi_dma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net to_float_0_M_AXIS_RESULT [get_bd_intf_pins exp_0/S_AXIS_A] [get_bd_intf_pins to_float_0/M_AXIS_RESULT]

  # Create port connections
  connect_bd_net -net microblaze_0_Clk [get_bd_pins m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins exp_0/aclk] [get_bd_pins to_float_0/aclk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_resetn] [get_bd_pins axi_dma_0/axi_resetn]
...
proc create_root_design { parentCell } {
  ...
  set MOTOR_DIR [ create_bd_port -dir O -from 1 -to 0 MOTOR_DIR ]
  set MOTOR_EN_0 [ create_bd_port -dir O MOTOR_EN_0 ]
  set MOTOR_EN_1 [ create_bd_port -dir O MOTOR_EN_1 ]
  ...
  # Create instance: exp
  create_hier_cell_exp [current_bd_instance .] exp
  ...
  # Create instance: motor_dir_gpio_0, and set properties
  set motor_dir_gpio_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 motor_dir_gpio_0 ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
   CONFIG.C_GPIO_WIDTH {2} \
 ] $motor_dir_gpio_0

  # Create instance: motor_en_timer_0, and set properties
  set motor_en_timer_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_timer:2.0 motor_en_timer_0 ]
  set_property -dict [ list \
   CONFIG.enable_timer2 {1} \
 ] $motor_en_timer_0

  # Create instance: motor_en_timer_1, and set properties
  set motor_en_timer_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_timer:2.0 motor_en_timer_1 ]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M05_AXI [get_bd_intf_pins motor_en_timer_0/S_AXI] [get_bd_intf_pins smartconnect_0/M05_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M11_AXI [get_bd_intf_pins motor_en_timer_1/S_AXI] [get_bd_intf_pins smartconnect_0/M11_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M12_AXI [get_bd_intf_pins motor_dir_gpio_0/S_AXI] [get_bd_intf_pins smartconnect_0/M12_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M13_AXI [get_bd_intf_pins led_gpio_0/S_AXI] [get_bd_intf_pins smartconnect_0/M13_AXI]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports MOTOR_DIR] [get_bd_pins motor_dir_gpio_0/gpio_io_o]
  connect_bd_net -net axi_gpio_0_gpio_io_o1 [get_bd_ports LED] [get_bd_pins led_gpio_0/gpio_io_o]
  connect_bd_net -net axi_quad_spi_0_ip2intc_irpt [get_bd_pins axi_intc_0/intr] [get_bd_pins axi_quad_spi_0/ip2intc_irpt]
  connect_bd_net -net axi_timer_0_pwm0 [get_bd_ports MOTOR_EN_0] [get_bd_pins motor_en_timer_0/pwm0]
  connect_bd_net -net axi_timer_1_pwm0 [get_bd_ports MOTOR_EN_1] [get_bd_pins motor_en_timer_1/pwm0]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins acquisition/aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_quad_spi_0/s_axi4_aclk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins exp/m_axi_mm2s_aclk] [get_bd_pins led_gpio_0/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/sys_clk_i] [get_bd_pins motor_dir_gpio_0/s_axi_aclk] [get_bd_pins motor_en_timer_0/s_axi_aclk] [get_bd_pins motor_en_timer_1/s_axi_aclk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins stft/m_axi_mm2s_aclk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins acquisition/aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins exp/axi_resetn] [get_bd_pins led_gpio_0/s_axi_aresetn] [get_bd_pins motor_dir_gpio_0/s_axi_aresetn] [get_bd_pins motor_en_timer_0/s_axi_aresetn] [get_bd_pins motor_en_timer_1/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins stft/axi_resetn] [get_bd_pins tcu/axi_resetn]
  ...
  assign_bd_address -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs led_gpio_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs motor_dir_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x41C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs motor_en_timer_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x41C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs motor_en_timer_1/S_AXI/Reg] -force
  ...
  exclude_bd_addr_seg -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces acquisition/axi_dma_0/Data_S2MM] [get_bd_addr_segs led_gpio_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces acquisition/axi_dma_0/Data_S2MM] [get_bd_addr_segs motor_dir_gpio_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x41C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces acquisition/axi_dma_0/Data_S2MM] [get_bd_addr_segs motor_en_timer_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x41C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces acquisition/axi_dma_0/Data_S2MM] [get_bd_addr_segs motor_en_timer_1/S_AXI/Reg]
  ...
  exclude_bd_addr_seg -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces exp/axi_dma_0/Data_MM2S] [get_bd_addr_segs axi_quad_spi_0/aximm/MEM0]
  exclude_bd_addr_seg -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces exp/axi_dma_0/Data_MM2S] [get_bd_addr_segs axi_quad_spi_0/AXI_LITE/Reg]
  ...
  exclude_bd_addr_seg -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces exp/axi_dma_0/Data_MM2S] [get_bd_addr_segs led_gpio_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces exp/axi_dma_0/Data_MM2S] [get_bd_addr_segs motor_dir_gpio_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x41C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces exp/axi_dma_0/Data_MM2S] [get_bd_addr_segs motor_en_timer_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x41C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces exp/axi_dma_0/Data_MM2S] [get_bd_addr_segs motor_en_timer_1/S_AXI/Reg]
  ...
  exclude_bd_addr_seg -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces exp/axi_dma_0/Data_S2MM] [get_bd_addr_segs axi_quad_spi_0/aximm/MEM0]
  ...
  exclude_bd_addr_seg -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces exp/axi_dma_0/Data_S2MM] [get_bd_addr_segs led_gpio_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces exp/axi_dma_0/Data_S2MM] [get_bd_addr_segs motor_dir_gpio_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x41C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces exp/axi_dma_0/Data_S2MM] [get_bd_addr_segs motor_en_timer_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x41C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces exp/axi_dma_0/Data_S2MM] [get_bd_addr_segs motor_en_timer_1/S_AXI/Reg]
  ...
  exclude_bd_addr_seg -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces stft/axi_dma_0/Data_MM2S] [get_bd_addr_segs led_gpio_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces stft/axi_dma_0/Data_MM2S] [get_bd_addr_segs motor_dir_gpio_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x41C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces stft/axi_dma_0/Data_MM2S] [get_bd_addr_segs motor_en_timer_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x41C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces stft/axi_dma_0/Data_MM2S] [get_bd_addr_segs motor_en_timer_1/S_AXI/Reg]
  ...
  exclude_bd_addr_seg -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces stft/axi_dma_0/Data_S2MM] [get_bd_addr_segs led_gpio_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces stft/axi_dma_0/Data_S2MM] [get_bd_addr_segs motor_dir_gpio_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x41C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces stft/axi_dma_0/Data_S2MM] [get_bd_addr_segs motor_en_timer_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x41C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces stft/axi_dma_0/Data_S2MM] [get_bd_addr_segs motor_en_timer_1/S_AXI/Reg]
  ...
  exclude_bd_addr_seg -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces stft/axi_dma_0/Data_SG] [get_bd_addr_segs led_gpio_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces stft/axi_dma_0/Data_SG] [get_bd_addr_segs motor_dir_gpio_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x41C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces stft/axi_dma_0/Data_SG] [get_bd_addr_segs motor_en_timer_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x41C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces stft/axi_dma_0/Data_SG] [get_bd_addr_segs motor_en_timer_1/S_AXI/Reg]
  ...
  exclude_bd_addr_seg -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces tcu/axi_dma_0/Data_MM2S] [get_bd_addr_segs led_gpio_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces tcu/axi_dma_0/Data_MM2S] [get_bd_addr_segs motor_dir_gpio_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x41C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces tcu/axi_dma_0/Data_MM2S] [get_bd_addr_segs motor_en_timer_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x41C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces tcu/axi_dma_0/Data_MM2S] [get_bd_addr_segs motor_en_timer_1/S_AXI/Reg]
  ...
  exclude_bd_addr_seg -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces tcu/top_speech_robot_0/m_axi_dram0] [get_bd_addr_segs axi_intc_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x90000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces tcu/top_speech_robot_0/m_axi_dram0] [get_bd_addr_segs axi_quad_spi_0/aximm/MEM0]
  exclude_bd_addr_seg -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces tcu/top_speech_robot_0/m_axi_dram0] [get_bd_addr_segs axi_quad_spi_0/AXI_LITE/Reg]
  ...
  exclude_bd_addr_seg -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces tcu/top_speech_robot_0/m_axi_dram0] [get_bd_addr_segs led_gpio_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces tcu/top_speech_robot_0/m_axi_dram0] [get_bd_addr_segs motor_dir_gpio_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x41C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces tcu/top_speech_robot_0/m_axi_dram0] [get_bd_addr_segs motor_en_timer_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x41C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces tcu/top_speech_robot_0/m_axi_dram0] [get_bd_addr_segs motor_en_timer_1/S_AXI/Reg]
  ...
  exclude_bd_addr_seg -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces tcu/top_speech_robot_0/m_axi_dram1] [get_bd_addr_segs axi_intc_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x90000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces tcu/top_speech_robot_0/m_axi_dram1] [get_bd_addr_segs axi_quad_spi_0/aximm/MEM0]
  exclude_bd_addr_seg -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces tcu/top_speech_robot_0/m_axi_dram1] [get_bd_addr_segs axi_quad_spi_0/AXI_LITE/Reg]
  exclude_bd_addr_seg -offset 0x40600000 -range 0x00010000 -target_address_space [get_bd_addr_spaces tcu/top_speech_robot_0/m_axi_dram1] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces tcu/top_speech_robot_0/m_axi_dram1] [get_bd_addr_segs led_gpio_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces tcu/top_speech_robot_0/m_axi_dram1] [get_bd_addr_segs motor_dir_gpio_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x41C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces tcu/top_speech_robot_0/m_axi_dram1] [get_bd_addr_segs motor_en_timer_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x41C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces tcu/top_speech_robot_0/m_axi_dram1] [get_bd_addr_segs motor_en_timer_1/S_AXI/Reg]
